...
print(f"Data type: {tensor_from_list.dtype}, Shape: {tensor_from_list.shape}")
...
print(f"Data type: {tensor_from_numpy.dtype}, Shape: {tensor_from_numpy.shape}")
